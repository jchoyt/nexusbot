 ...
 *
 * $Source: /var/lib/cvsd/cvsrepo/invasion/nw/nexusbot/src/nexusbot/EggTimerTask.java,v $
...
public class EggTimerTask extends TimerTask
{
    private Info info;
    private String message;
    private int minutes;

    public EggTimerTask( Info info, String message)
    {
        this.info = info;
